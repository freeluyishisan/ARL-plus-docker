...
def _post(path: str, payload: dict[str, Any]) -> dict[str, Any]:
    try:
        resp = requests.post(f"{AUTO_TOOLS_BASE_URL}{path}", json=payload, timeout=AUTO_MCP_TIMEOUT)
...
def auto_recon_pipeline(name: str, urls: list[str] | None = None, lines: str = "", run_katana: bool = True, run_nuclei: bool = False) -> dict[str, Any]:
    """Run staged workflow: httpx first, optionally katana, optionally nuclei."""
